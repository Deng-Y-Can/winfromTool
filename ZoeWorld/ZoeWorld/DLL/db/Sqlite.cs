...
namespace ZoeWorld.DLL.db
{
    ...
    namespace HomeView.DLL.DATABASE
    {
        public class SqliteHelper
        {
            ...
            {
                //DataSource = $@"E:\home\web\HomeView\HomeView\Home.db";
                DataSource = Application.StartupPath.ToString()+$@"\Home.db";//wwwroot为网页根目录
            }
